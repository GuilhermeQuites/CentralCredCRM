...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-slate-950">Novo usuario</h1>
        <p class="mt-1 text-sm text-slate-600">Cadastre o acesso e selecione as permissoes.</p>
    </div>

    <form method="POST" action="{{ route('users.store') }}" class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        @csrf
